...
============================================================================================
create table categories5 (id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY,catId INT, parentId INT,countryId INT,langId INT,name VARCHAR(50),catDesc VARCHAR(200),orderId TINYINT UNSIGNED,active TINYINT UNSIGNED);
...
// (90,-1,1,1,'JOBB',null,59,null,0,null,null,true),
...
// NEW 3
echo "INSERT INTO categories (catId, parentId, countryId, langId, name, extraId, orderId, catAdTypes, totalAds, pricePrivate, priceCompany, active) VALUES ";
...
*/
echo $c.$cId.$st. "BOSTAD" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "BOSTAD" .$m.$o.$e);

$o = getSubCats($c,$cId,$m,$o--,$e, "Lägenhet,Bostadsrätt,Fritidshus,Villa,Tomt,Radhus,Gård &amp; skog,Utlandsboenden,Övrigt");

/* XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX HUOM! SUOMEKSI!!!
echo $c.$cId.$s. "Asunto" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
  $o = getSubCats($c,$cId,$m,$o--,$e, "Kerrostalo,Rivitalo,Omakotitalo,Vapaa-ajan asunto,Erillistalo,Paritalo,Luhtitalo,Puutalo-osake,Muu");
echo $c.$cId.$s. "Loma-asunto" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
  $o = getSubCats($c,$cId,$m,$o--,$e, "Mökki tai huvila,Lomaosake,Lomahuoneisto");
echo $c.$cId.$s. "Tontti" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
  $o = getSubCats($c,$cId,$m,$o--,$e, "Omakotitalotontti,Vapaa-ajan tontti,Rivitalotontti,Muu tontti");
echo $c.$cId.$s. "Toimitila" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
  $o = getSubCats($c,$cId,$m,$o--,$e, "Liiketila,Tuotantotila,Toimistotila,Varastotila,Ravintolatila,Näyttelytila,Harrastustila,Hub-tila,Muu tila");
echo $c.$cId.$s. "Maa- tai metsätila" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
  $o = getSubCats($c,$cId,$m,$o--,$e, "Maatila,Metsätila");
echo $c.$cId.$s. "Autotalli" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
  $o = getSubCats($c,$cId,$m,$o--,$e, "Autopaikka,Katettu autopaikka,Autotalli,Lämmitetty autotalli");
*/



echo $c.$cId.$st. "JOBB" .$m.$o.$e; $o=$o+50; $cId=$cId+50; 
insert($c.$cId.$st. "JOBB" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Administration,Bygg/Anläggning/Infrastruktur,Data/IT,Drift/Underhåll,Ekonomi/Finans,Försäljning/Affärsutveckling,Försvar/Säkerhet/Räddningstjänst,Forskning/R&D/Vetenskap,HR/Personal,Hotell/Restaurang/Turism/Nöje,Juridik/Rättsvetenskap,Kreativitet/Design,Kundsupport/Service,Kvalitetssäkring,Ledning/Management,Logistik/Transport,Marknad/Produkt,Projektledning,Sjukvård/Hälsa,Skribenter/publishing,Teknik/Ingenjörstjänster,Tillverkning/Produktion,Utbildning");
...
echo $c.$cId.$st. "FORDON" .$m.$o.$e; $o=$o+50; $cId=$cId+500;
insert($c.$cId.$st. "FORDON" .$m.$o.$e);
echo $c.$cId.$s. "Bilar" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Bilar" .$m.$o.$e);
	$o = getSubCats($c,$cId,$m,$o--,$e, "AlfaRomeo,AstonMartin,Audi,Austin,Bentley,BMW,Buick,Cadillac,Chevrolet,Chrysler,Citro&euml;n,Dacia,Daewoo,Dodge,Ferrari,Fiat,Ford,GMC,Honda,Hummer,Hyundai,Infiniti,Isuzu,Iveco,Jaguar,Jeep,Kia,Lada,Lamborghini,Lancia,LandRover,Lexus,Lincoln,Lotus,Maserati,Mazda,McLaren,Mercedes-Benz,Mercury,Mini,Mitsubishi,Nissan,Oldsmobile,Opel,Peugeot,Plymouth,Pontiac,Porsche,Renault,Rolls-Royce,Rover&#47;BMC,Saab,SEAT,Skoda,Smart,SsangYong,Subaru,Suzuki,Tesla,Toyota,Volkswagen,Volvo");
 
// Småbil,Sedan,Halvkombi,Kombi,Coup&eacute;,Cab,SUV,Familjebuss,Yrkesfordon (extra)
// Vit,Grå&#47;Silver,Brun,Svart,Röd&#47;Orange,Gul,Grön,Blå&#47;Lila (extra)


echo $c.$cId.$s. "Bildelar &amp; biltillbehör" .$m.$o.$e; $o=$o+800;
insert($c.$cId.$s. "Bildelar &amp; biltillbehör" .$m.$o.$e);
	$o = getSubCats($c,$cId,$m,$o--,$e, "Bilstereo,Däck &amp; fälg,GPS,Reservdelar,Släp,Takboxar &amp; takräcken,Övrigt");
echo $c.$cId.$s. "Båtar" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //  0,1,3  !!!!------------
insert($c.$cId.$s. "Båtar" .$m.$o.$e);
 	$o = getSubCats($c,$cId,$m,$o--,$e, "Motorbåt,Segelbåt,Gummi&#47;ribbåt,Jolle&#47;roddbåt,Kajak&#47;kanot,Vattenskoter,Övrigt");
echo $c.$cId.$s. "Båtdelar &amp; tillbehör" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Båtdelar &amp; tillbehör" .$m.$o.$e);
 	$o = getSubCats($c,$cId,$m,$o--,$e, "Motor &amp; propeller,GPS &amp; navigering,Båtplats &amp; förvaring,Trailer,Övrigt");
echo $c.$cId.$s. "Husvagnar &amp; husbilar" .$m.$o.$e; $o=$o+50; $cId=$cId+50; // 0,1,3 !!!! 
insert($c.$cId.$s. "Husvagnar &amp; husbilar" .$m.$o.$e);
 	$o = getSubCats($c,$cId,$m,$o--,$e, "Husvagn,Husbil,Tillbehör");
echo $c.$cId.$s. "Mopeder &amp; A-traktor" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Mopeder &amp; A-traktor" .$m.$o.$e);
 	$o = getSubCats($c,$cId,$m,$o--,$e, "Mopeder,A-Traktorer,Tillbehör");
echo $c.$cId.$s. "Motorcyklar" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Motorcyklar" .$m.$o.$e);
 	$o = getSubCats($c,$cId,$m,$o--,$e, "Cross&#47;enduro,Custom,Fyrhjuling&#47;ATV,Offroad,Scooter,Sport,Touring,Övrigt");
echo $c.$cId.$s. "MC-delar &amp; tillbehör" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "MC-delar &amp; tillbehör" .$m.$o.$e);
 	$o = getSubCats($c,$cId,$m,$o--,$e, "Däck &amp; fälg,Reservdelar,Hjälm&#47;skydd&#47;kläder,Övrigt");
//echo $c.$cId.$s. "Lastbil, truck &amp; entreprenad" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
// 	$o = getSubCats($c,$cId,$m,$o--,$e, "Entreprenad­maskiner,Lastbil &amp; buss,Truck &amp; material­hantering");
//echo $c.$cId.$s. "Skogs- &amp; lantbruksmaskiner" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
//$o = getSubCats($c,$cId,$m,$o--,$e, 'Grönyte­maskiner,Lantbruks­maskiner,Skogs­maskiner');
echo $c.$cId.$s. "Snöskotrar" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Snöskotrar" .$m.$o.$e);
echo $c.$cId.$s. "Snöskoterdelar &amp; tillbehör" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Snöskoterdelar &amp; tillbehör" .$m.$o.$e);
// moved mascus to end
echo $c.$cId.$st. "FÖR HEMMET" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "FÖR HEMMET" .$m.$o.$e);
echo $c.$cId.$s. "Bygg &amp; trädgård" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Bygg &amp; trädgård" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Badrum&#47;WC&#47;bastu,Byggmaterial,Kamin &amp; värme,Kök,Trädgårds­maskiner,Trädgård &amp; uteplats,Övrigt");
echo $c.$cId.$s. "Möbler &amp; heminredning" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Möbler &amp; heminredning" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Antikt &amp; konst,Belysning,Bord &amp; stolar,Hemtextil &amp; prydnad,Hyllor &amp; förvaring,Mattor,Säng &amp; sovrum,Soffa&#47;fåtölj&#47;soffmöbler,TV- &amp; stereomöbler,Övrigt");
echo $c.$cId.$s. "Husgeråd &amp; vitvaror" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Husgeråd &amp; vitvaror" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Diskmaskin,Kyl &amp; frys,Kökstillbehör &amp; porslin,Spis &amp; micro,Tvättmaskin &amp; torktumlare,Övrigt");
echo $c.$cId.$s. "Verktyg" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Verktyg" .$m.$o.$e);

echo $c.$cId.$st. "PERSONLIGT" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "PERSONLIGT" .$m.$o.$e);
echo $c.$cId.$s. "Kläder &amp; skor för kvinnor" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Kläder &amp; skor för kvinnor" .$m.$o.$e);
 	// Dam &amp; herr,Dam,Herr (radio)
  	//$o = getSubCats($c,$cId,$m,$o--,$e, "Brudklänningar,Byxor,Jackor &amp; ytterplagg,Jeans,Kjolar &amp; klänningar,Kostymer &amp; kavajer,Skjortor,Skor,Toppar,Tröjor,Övrigt"); // old
    $o = getSubCats($c,$cId,$m,$o--,$e, "Klänningar,Toppar,Skjortor & Blusar,Badkläder,Stickat,Koftor & Jumpers,Hoodies & Sweatshirts,Kavajer & Västar,Jackor & Kappor,Byxor,Jeans,Kjolar,Jumpsuits,Underkläder,Sovplagg,Sportkläder,Shorts,Skor,Accessoarer,Strumpor & Tights,Mammakläder,Övrigt");
echo $c.$cId.$s. "Kläder &amp; skor för män" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Kläder &amp; skor för män" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "T-shirts & Linnen,Hoodies & Sweatshirts,Byxor,Jeans,Koftor & Tröjor,Ytterplagg,Skjortor,Kavajer & Kostymer,Accessoarer,Skor,Strumpor,Underkläder & Sovplagg,Shorts,Badkläder,Sportkläder,Övrigt");


echo $c.$cId.$s. "Accessoarer &amp; klockor" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Accessoarer &amp; klockor" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Klockor,Smycken,Väskor,Övrigt");
echo $c.$cId.$s. "Barnkläder &amp; skor" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Barnkläder &amp; skor" .$m.$o.$e);
 	//Flicka &amp; pojke,Flicka,Pojke,Unisex (radio)
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Kläder,Skor");
echo $c.$cId.$s. "Barnartiklar &amp; leksaker" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Barnartiklar &amp; leksaker" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Barnmöbler,Barnvagnar &amp; tillbehör,Bilbarnstolar,Leksaker,Övrigt");

echo $c.$cId.$st. "ELEKTRONIK" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "ELEKTRONIK" .$m.$o.$e);
//echo $c.$cId.$s. "Datorer &amp; TV-spel" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
//  	$o = getSubCats($c,$cId,$m,$o--,$e, "Stationära datorer,Bärbara datorer,Surfplattor,Datortillbehör &amp; program,PC-spel &amp; onlinespel,TV-spel,Övrigt");
echo $c.$cId.$s. "Datorer" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Datorer" .$m.$o.$e);
$o = getSubCats($c,$cId,$m,$o--,$e, "Stationära datorer,Bärbara datorer,Surfplattor,Datortillbehör &amp; program,Övrigt");

echo $c.$cId.$s. "Spel" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Spel" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Action,Barnspel,Dansspel,Familjespel,Fighting,First person shooter,Musik,Nyttoprogram,Onlinespel,Partyspel,Pistolspel,Plattform,Pusselspel,Racing,Retro,Rollspel,Simulation,Sport,Strategi,Träning,Utbildning,Äventyr,Övrigt");



// OLD
echo $c.$cId.$s. "Ljud &amp; bild" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Ljud &amp; bild" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Foto- &amp; videokameror,MP-spelare,Stereo &amp; surround,Video- &amp; DVD-spelare,TV &amp; projektor,Övrigt");
// NEW
echo $c.$cId.$s. "Filmer &amp; TV-serier" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Filmer &amp; TV-serier" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Anime,Action,Dokumentär,Drama,Familj & Barn,Filmboxar,Import,Komedi,Rysare,Science Fiction,Svenskt,Tecknat & Animerat,Thriller,Tv-serier,Western,Äventyr & Fantasy,Övrigt");
echo $c.$cId.$s. "Musik" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Musik" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Pop & Rock,Hårdrock,Svenskt,Dansband,Filmmusik,Barn,Reggae,Samlingar,Country,Jazz & Blues,Klassiskt,Soul & R&B,Hip Hop,Trance & Dance,Julmusik,Övrigt");
// Foto- &amp; videokameror


//echo $c.$cId.$s. "Telefoner &amp; tillbehör" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
//  	$o = getSubCats($c,$cId,$m,$o--,$e, "Telefoner,Tillbehör");
echo $c.$cId.$s. "Telefoner" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Telefoner" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Apple,Huawei,Doogee,Oukitel,Asus,Cubot,Ulefone,Samsung,Umidigi,Blackview,OnePlus,Nokia");
echo $c.$cId.$s. "Telefon tillbehör" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Telefon tillbehör" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Mobilskal,Skärmskydd,Laddare,Kablar,Mobiltillbehör,Smartwatches,Träningsklockor,GPS & Navigation,Fast Telefoni,Övrigt");

echo $c.$cId.$st. "FRITID &amp; HOBBY" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "FRITID &amp; HOBBY" .$m.$o.$e);
echo $c.$cId.$s. "Biljetter" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Biljetter" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Konsert,Teater &amp; show,Presentkort,Sport,Övrigt");
echo $c.$cId.$s. "Resor" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Resor" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Tåg,Charter- &amp; paketresor,Övriga resor");
echo $c.$cId.$s. "Böcker &amp; studentlitteratur" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Böcker &amp; studentlitteratur" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Almanackor & kalendrar,Barnböcker,Barn & Familj,Biografier & Sanna Berättelser,Datorer & IT,Deckare & Thrillers,Djur & Natur,Ekonomi & Marknadsföring,Fantasy & Science Fiction,Film & Musik,Geografi & Resor,Historia & Arkeologi,Hobby & Fritid,Hus & Hem,Juridik,Kultur,Kurslitteratur,Mat & Dryck,Naturvetenskap & Teknik,Psykologi & Pedagogik,Religion & Filosofi,Registerflikar,Samhälle & Politik,Serier & Humor,Sex & Erotik,Skönlitteratur,Språk & Uppslagsverk,Träning & Hälsa,Unga vuxna,Övrigt");

echo $c.$cId.$s. "Cyklar" .$m.$o.$e; $o=$o+50; $cId=$cId+500;
insert($c.$cId.$s. "Cyklar" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Dam,Herr,Barn,Mountainbike,Racer,Övriga cyklar,Tillbehör");

// NEW
echo $c.$cId.$st. "DJUR" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "DJUR" .$m.$o.$e);
echo $c.$cId.$s. "Hund" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Hund" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Labrador retriever,Tysk schäferhund,Golden retriever,Jämthund,Shetland sheepdog,Cocker spaniel,Bichon havanais,Staffordshire bullterrier,Chihuahua,Fransk bulldogg,Drever,Finsk lapphund,Border collie,Dansk-svensk gårdshund,Flatcoated retriever,Cavalier king charles spaniel,Mops,Rottweiler,Tax,Engelsk springer spaniel");
echo $c.$cId.$s. "Katt" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Katt" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Maine coon,Ragdoll,Sibirisk katt,Norsk skogkatt,Benga,Devon rex,Brittisk korthår,Cornish rex,Helig birma,Abessinier,Perser");

echo $c.$cId.$s. "Gnagare &amp; kaniner" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Gnagare &amp; kaniner" .$m.$o.$e);
echo $c.$cId.$s. "Reptil" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Reptil" .$m.$o.$e);
echo $c.$cId.$s. "Fågel" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Fågel" .$m.$o.$e);
echo $c.$cId.$s. "Fisk" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Fisk" .$m.$o.$e);
echo $c.$cId.$s. "Lantbruksdjur" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Lantbruksdjur" .$m.$o.$e);
echo $c.$cId.$s. "Övriga djur" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Övriga djur" .$m.$o.$e);
echo $c.$cId.$s. "Katt- &amp; hundtillbehör" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Katt- &amp; hundtillbehör" .$m.$o.$e);
echo $c.$cId.$s. "Tillbehör" .$m.$o.$e; $o=$o+5;
insert($c.$cId.$s. "Tillbehör" .$m.$o.$e);
//  	$o = getSubCats($c,$cId,$m,$o--,$e, "Hund,Katt,Katt- &amp; hundtillbehör,Gnagare &amp; kaniner,Reptil,Fågel,Fisk,Lantbruksdjur,Övriga djur,Tillbehör");
/*
...
*/
echo $c.$cId.$s. "Hobby &amp; samlarprylar" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Hobby &amp; samlarprylar" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Frimärken &amp; mynt,Hobbyfordon,Radiostyrt &amp; modell,Serietidningar,Symaskin &amp; textil,Historiska föremål,Övrigt");
echo $c.$cId.$s. "Hästar &amp; ridsport" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Hästar &amp; ridsport" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Hästar,Ponnys,Utrustning,Foder &amp; stall,Medryttare &amp; fodervärd,Släp &amp; transport,Övrigt");
echo $c.$cId.$s. "Jakt &amp; fiske" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Jakt &amp; fiske" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Jakt,Fiske,Övrigt");
echo $c.$cId.$s. "Musikutrustning" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Musikutrustning" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Gitarr&#47;bas&#47;förstärkare,Piano &amp; klaviatur,Dragspel,Blåsinstrument,Trummor &amp; slagverk,Studio- &amp; scenutrustning,Övrigt");
echo $c.$cId.$s. "Sport &amp; fritid" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Sport &amp; fritid" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Bollsport,Camping &amp; friluftsliv,Dyk- &amp; vattensport,Golf,Träning &amp; hälsa,Vintersport,Övrigt");

echo $c.$cId.$st. "AFFÄRSVERKSAMHET" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "AFFÄRSVERKSAMHET" .$m.$o.$e);
//  	$o = getSubCats($c,$cId,$m,$o--,$e, "Butik,Domäner &amp; sajter,Frisörsalong,Restaurang &amp; café,Övrigt");

// OLD
//echo $c.$cId.$s. "Lokaler &amp; fastigheter" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //   0,1,2,3,4  !!!
//  	$o = getSubCats($c,$cId,$m,$o--,$e, "Butiker,Industri &amp; verkstad,Lager &amp; förråd,Kontor,Övrigt");

echo $c.$cId.$s. "Lokaler" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Lokaler" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Butiker,Industrier &amp; verkstäder,Kontor,Kontorshotell,Lager &amp; logistik,Övrigt");

// otettu vanhasta
   //echo $c.$cId.$s. "Butiker" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //   0,1,2,3,4  !!!    $o = 
   /*getSubCats($c,$cId,$m,$o--,$e, "Industrier &amp; verkstäder,Kontor,Kontorshotell,Lager &amp; logistik,Övrigt*/

   // otettu vanhasta
echo $c.$cId.$s. "Inventarier &amp; maskiner" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Inventarier &amp; maskiner" .$m.$o.$e);
    $o = getSubCats($c,$cId,$m,$o--,$e, "Butik &amp; kassa,Frisör- &amp; skönhetssalong,Kontor,Industrimaskiner,Restaurang &amp; café,Varuparti &amp; konkurslager,Övrigt");
    echo $c.$cId.$s. "Fastigheter" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //   0,1,2,3,4  !!!
insert($c.$cId.$s. "Fastigheter" .$m.$o.$e);
     $o = getSubCats($c,$cId,$m,$o--,$e, "Bostäder,Butiker,Industrier &amp; verkstäder,Kontor,Lager &amp; logistik,Övrigt");

   echo $c.$cId.$s. "Mark" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //   0,1,2,3,4  !!!
insert($c.$cId.$s. "Mark" .$m.$o.$e);
     $o = getSubCats($c,$cId,$m,$o--,$e, "Industritomter,Lager och logistiktomter,Tomter&comma; bostadsfastigheter,Tomter&comma; handel,Övrigt");

   echo $c.$cId.$s. "Företag" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //   0,1,2,3,4  !!!
insert($c.$cId.$s. "Företag" .$m.$o.$e);
     $o = getSubCats($c,$cId,$m,$o--,$e, "Butiker,Byggverksamhet,Handel &amp; e-handel&comma; domäner&comma; sajter,Frisörsalong,Hotell &amp; turistföretag,Restauranger &amp; caféer,Tillverkande företag,Tjänsteföretag,Transportföretag,Vård &amp; Hälsa,Övrigt");



echo $c.$cId.$s. "Tjänster" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Tjänster" .$m.$o.$e);
  	$o = getSubCats($c,$cId,$m,$o--,$e, "Bil &amp; motor,Catering,Data,Djuravel,Ekonomi,Flytt &amp; transport,Hantverkare,Hundvakt &amp; djurskötsel,Kosmetik &amp; hårvård,Musik &amp; underhållning,Städning,Trädgård &amp; markarbeten,Undervisning");


// ---------------- MASCUS -------------------
echo $c.$cId.$st. "TUNGA MASKINER" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$st. "TUNGA MASKINER" .$m.$o.$e);
echo $c.$cId.$s. "Entreprenad" .$m.$o.$e; $o=$o+50; $cId=$cId+50; // 1
insert($c.$cId.$s. "Entreprenad" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Grävmaskiner,Lastare,Liftar,Kranar,Återvinning & sortering,Asfalteringsmaskiner,Borrutrustning,Byggmaskiner - Annat,Cementutrustning,Dumprar,Generatorer,Grävlastare,Kompressorutrustning,Marinutrustning,Olja- och gasutrustning,Pålningsutrustning,Redskap och utrustning,Reservdelar,Schaktmaskiner,Teleskoplastare,Utrustning för underjordsbrytning,Vägbyggnadsmaskiner,Vibratorplattor,Övriga");
  
echo $c.$cId.$s. "Lantbruk" .$m.$o.$e; $o=$o+50; $cId=$cId+50; // 2
insert($c.$cId.$s. "Lantbruk" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Traktorer,Vallskörd,Jordbearbetning,Tröskor,Mineral- och stallgödselspridare,Bevattning,Inomgårdsutrustning,Lastning och grävning,Maskiner för sådd och sättning,Maskiner för väg och snö,Olivskördningsutrustning,Potatisodlingsutrustning,Processering och lagring av skörd,Reservdelar,Självgående fälthackar,Terränghjulingar och skotrar,Tillbehör,Vagnar,Växtskyddsprutor,Vinodlings utrustning,Övriga lantbruksmaskiner");
  
echo $c.$cId.$s. "Transportfordon" .$m.$o.$e; $o=$o+50; $cId=$cId+500; // 3
insert($c.$cId.$s. "Transportfordon" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Lastbilar,Lätta last- och skåpbilar < 3&comma;5 ton,Dragbilar,Trailers,Släpvagnar,Brandbilar & andra samhälls service bilar,Bussar,Containrar,Elektriska fordon,Lasthantering,Lösa byggnation,Personbilar,Reservdelar,Terrängfordon,Övriga");
  
echo $c.$cId.$s. "Materialhantering" .$m.$o.$e; $o=$o+50; $cId=$cId+50; // 4
insert($c.$cId.$s. "Materialhantering" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Motviktstruckar,Staplare,Låglyftare,Skjutstativtruck,Specialutrustning,Containertruck,Lagerstädmaskiner,Lagerutrustning,Plocktruckar,Reservdelar,Tillbehör och komponenter,Övriga");
  
echo $c.$cId.$s. "Grönytemaskiner" .$m.$o.$e; $o=$o+50; $cId=$cId+50; // 5
insert($c.$cId.$s. "Grönytemaskiner" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Gräsklippare,Sopmaskiner,Kompakttraktorer,Golf- och sport grönytemaskiner,Redskapsbärare,Häcksaxar,Kompakttraktor-tillbehör,Reservdelar,Strand-rengöringsutrustning,Tvåhjulstraktorer och kultivatorer,Utrustning för högtryckstvätt,Verktygsfraktare,Övriga grönytemaskiner");
  
echo $c.$cId.$s. "Skogsmaskiner" .$m.$o.$e; $o=$o+50; $cId=$cId+50; // 6
insert($c.$cId.$s. "Skogsmaskiner" .$m.$o.$e);
  $o = getSubCats($c,$cId,$m,$o--,$e, "Trähantering,Skördare,Skotare,Lunnare,Fällare-läggare,Drivare,Grävmaskiner,Kvistare,Övriga skogsmaskiner,Redskap och utrustning,Reservdelar,Sågverk,Skogstraktorer,Terminal Lastare");


// ---------------- END MASCUS -------------------

echo $c.$cId.$s. "Efterlysningar" .$m.$o.$e; $o=$o+50; $cId=$cId+50; //  (tyhjä) 
insert($c.$cId.$s. "Efterlysningar" .$m.$o.$e); // !!!!-----------------------
echo $c.$cId.$s. "Övrigt" .$m.$o.$e; $o=$o+50; $cId=$cId+50;
insert($c.$cId.$s. "Övrigt" .$m.$o.$e);




function getSubCats($c,$cId,$m, $o, $e, $subCats) {
	$subCatsArr = explode(',',$subCats);
	$localOrderId = 0;
	$parentId = $o;
	for($i=0; $i<count($subCatsArr); $i++) {
		//echo " (" . $parentId . ",1,1,'" . $subCatsArr[$i] . $m . $localOrderId . $e;
    //echo $c . $cId .','. $parentId . ",1,1,'" . $subCatsArr[$i] . $m . $localOrderId . $e;
    //echo $c . $cId .','. $parentId . ",2661886,1,'" . $subCatsArr[$i] . $m . $localOrderId . $e;
    
    // (4062,4026,2661886,1,'Bussar',null,6,null,0,null,null,true),
    insert($c . $cId .','. $parentId . ",2661886,1,'" . $subCatsArr[$i] . $m . $localOrderId . $e);
		$localOrderId++;
    $cId = $cId + 2;
	}
...
function insert($data)
{
    ...
    $sql = "INSERT INTO categories5 (catId, parentId, countryId, langId, name, extraId, orderId, catAdTypes, totalAds, pricePrivate, priceCompany, active) VALUES (" . $data . ")";
    //$sql = "(" . $data . "),";
    echo "" . $sql . "<br>";

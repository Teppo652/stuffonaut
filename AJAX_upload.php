...
birthYear (2)
birthDate
birthMonth (2) ( --> horoscope sign)
mother tongue Id
other languages Ids (51,52,53)
marital status Id (single, living together, married, separated, vidow)
race Id (caucasian,black,asian,hispanic etc.) ?
has children BOOL
has underage children BOOL
has pets BOOL
working situation Id (student,not on working life,retired)
works at company
has bicycle
has car / motorbike
...
echo "INSERT INTO $table (parentId,countryId,langId,name,extraId,orderId,catAdTypes,totalAds,pricePrivate,priceCompany,active) VALUES ";
...
echo $s. "Maa- tai metsätila" .$m.$o.$e; $o++;
  $o = getSubCats($m,$o--,$e, "Maatila,Metsätila");
echo $s. "Autotalli" .$m.$o.$e; $o++;
...
echo $st. "FORDON & TUNGA MASKINER" .$m.$o.$e; $o++;
echo $s. "Bilar" .$m.$o.$e; $o++;
...
echo $s. "Transportfordon" .$m.$o.$e; $o++; // 3
...
echo $s. "Materialhantering" .$m.$o.$e; $o++; // 4
...
echo $s. "Grönytemaskiner" .$m.$o.$e; $o++; // 5
...
echo $s. "Skogsmaskiner" .$m.$o.$e; $o++; // 6
...
echo $s. "Husgeråd &amp; vitvaror" .$m.$o.$e; $o++;
  	$o = getSubCats($m,$o--,$e, "Diskmaskin,Kyl &amp; frys,Kökstillbehör &amp; porslin,Spis &amp; micro,Tvättmaskin &amp; torktumlare,Övrigt");
echo $s. "Verktyg" .$m.$o.$e; $o++;

echo $st. "PERSONLIGT" .$m.$o.$e; $o++;
echo $s. "Kläder &amp; skor för kvinnor" .$m.$o.$e; $o++;
 	// Dam &amp; herr,Dam,Herr (radio)
...
echo $s. "Kläder &amp; skor för män" .$m.$o.$e; $o++;
...
echo $s. "Böcker &amp; studentlitteratur" .$m.$o.$e; $o++;
...
echo $s. "Efterlysningar" .$m.$o.$e; $o++; //  (tyhjä) !!!!-----------------------
echo $s. "Övrigt" .$m.$o.$e; $o++;
